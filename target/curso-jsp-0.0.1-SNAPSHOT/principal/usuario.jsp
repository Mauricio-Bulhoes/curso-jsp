...
<body>
													...
													<div class="card-block">
														...
														<form class="form-material" enctype="multipart/form-data" action="<%=request.getContextPath()%>/ServletUsuarioController" method="post" id="formUser">
															...
															<div class="form-group form-default form-static-label">
																<input type="text" name="id" id="id" class="form-control" required="" readonly="readonly" value="${modelLogin.id}"> 
															...
															<button type="button" class="btn btn-primary waves-effect waves-light" onclick="limparForm();">Cadastrar</button>
	...
	<script type="text/javascript">
		...
		function visualizarImg(fotoembase64, filefoto){
			...
			var fileUser = document.getElementById(filefoto).files[0]; // campo IMG do usuário, apenas 1 foto, pois pode haver mais
				...
				success : function(response, textStatus, xhr) {
					...
					for (var p = 0; p < json.length; p++) {
						$('#tabelaresultados > tbody').append(
							'<tr> <td>' + json[p].id
							+ '</td> <td> ' + json[p].nome
							+ '</td> <td><button onclick="verEditar(' + json[p].id
